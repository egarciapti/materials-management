...
async function fetchFilteredData() {
    ...
    const url = `https://script.google.com/macros/s/AKfycbxKS6xL2QwuiCv5Ehq9MnhPaSxu9NAw2i0rGjSTV509BKWExOwyRvo5oZWFKERhzvA/exec?date=${encodeURIComponent(selectedDate)}`;
